...
// Pega a URL base do env ou usa o padrão
$app_url = isset($_ENV['APP_URL']) ? rtrim($_ENV['APP_URL'], '/') : 'http://localhost';

// Pega a porta do env ou 80 (porta padrão HTTP)
$app_port = isset($_ENV['APP_PORT']) ? trim($_ENV['APP_PORT']) : '80';

// Se a porta for 80 (padrão HTTP) ou vazia, não adiciona a porta na URL
if ($app_port === '80' || $app_port === '') {
    $config['base_url'] = $app_url . '/';
} else {
    $config['base_url'] = $app_url . ':' . $app_port . '/';
}
